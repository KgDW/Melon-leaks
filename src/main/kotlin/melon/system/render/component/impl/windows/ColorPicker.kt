...
import melon.system.config.setting.type.ColorSetting
...
import melon.system.render.graphic.VertexHelper
import org.lwjgl.opengl.GL11.*
import java.awt.Color

object ColorPicker : TitledWindow("Color Picker", 0.0f, 0.0f, 200.0f, 200.0f) {
    ...
    private fun drawColorField() {
        ...
        // Outline
        RenderUtils2D.drawRectOutline(fieldPos.first.x, fieldPos.first.y, fieldPos.second.x, fieldPos.second.y, 1.5f, RenderManager.Color.outline)
    ...
    private fun drawHueSlider() {
        ...
        // Outline
        RenderUtils2D.drawRectOutline(huePos.first.x, huePos.first.y, huePos.second.x, huePos.second.y, 1.5f, RenderManager.Color.outline)

        // Arrow pointer
        val interpolatedHue = prevHue + (hue - prevHue) * mc.renderPartialTicks
        val pointerPosY = huePos.first.y + fieldHeight * interpolatedHue
        RenderUtils2D.drawTriangleOutline(Vec2f(huePos.first.x - 6.0f, pointerPosY - 2.0f), Vec2f(huePos.first.x - 6.0, pointerPosY + 2.0), Vec2f(
            huePos.first.x - 2.0f, pointerPosY), 1.5f, RenderManager.Color.primary)
        RenderUtils2D.drawTriangleOutline(Vec2f(huePos.second.x + 2.0f, pointerPosY), Vec2f(huePos.second.x + 6.0, pointerPosY + 2.0), Vec2f(
            huePos.second.x + 6.0f, pointerPosY - 2.0f), 1.5f, RenderManager.Color.primary)
    }
    ...
    private fun drawColorPreview() {
        ...
        RenderUtils2D.drawRectOutline(prevColorPos.first.x, prevColorPos.first.y, prevColorPos.second.x, prevColorPos.second.y, 1.5f, RenderManager.Color.outline)
        ...
        RenderUtils2D.drawRectOutline(currentColorPos.first.x, currentColorPos.first.y, currentColorPos.second.x, currentColorPos.second.y, 1.5f, RenderManager.Color.outline)
