...
object ProjectionUtils {
    ...
    fun toScaledScreenPos(pos: Vec3d): Vec3d {
        return toScreenPos(
            pos,
            resolution.scaledWidth_double.toFloat(),
            resolution.scaledHeight_double.toFloat()
        )
    }
    ...
    fun updateMatrix() {
        ...
        val viewerPos =
            ActiveRenderInfo.projectViewFromEntity(entity, RenderUtils3D.partialTicks.toDouble())
