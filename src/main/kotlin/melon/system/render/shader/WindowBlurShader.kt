...
object WindowBlurShader : AlwaysListening, MinecraftWrapper {
    ...
    private val pass1 = Pass("/assets/melon/shaders/gui/WindowBlurH.vsh")
    private val pass2 = Pass("/assets/melon/shaders/gui/WindowBlurV.vsh")
    ...
    private open class Pass(vertShaderPath: String) :
        DrawShader(vertShaderPath, "/assets/melon/shaders/gui/WindowBlur.fsh") {
