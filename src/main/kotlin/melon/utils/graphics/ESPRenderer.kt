...
class ESPRenderer {
    ...
    fun add(pos: BlockPos, color: Color) {
    ...
    fun add(pos: BlockPos, color: Color, sides: Int) {
    ...
    fun add(box: AxisAlignedBB, color: Color) {
        add(box, ColorRGB(color), EnumFacingMask.ALL)
    }

    fun add(box: AxisAlignedBB, color: Color, sides: Int) {
    ...
    data class Info(val box: AxisAlignedBB, val color: ColorRGB, val sides: Int) {
        ...
        constructor(pos: BlockPos, color: Color) : this(AxisAlignedBB(pos), ColorRGB(color), EnumFacingMask.ALL)
        constructor(pos: BlockPos, color: Color, sides: Int) : this(AxisAlignedBB(pos), ColorRGB(color), sides)
    }
}