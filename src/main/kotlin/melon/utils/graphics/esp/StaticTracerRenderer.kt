...
class StaticTracerRenderer : AbstractRenderer() {
    ...
    object Shader : DrawShader("/assets/melon/shaders/general/StaticTracerRenderer.vsh", "/assets/melon/shaders/general/Renderer.fsh"), AlwaysListening {
