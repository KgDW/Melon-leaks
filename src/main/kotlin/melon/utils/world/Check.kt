...
import dev.zenhao.melon.utils.vector.VectorUtils.toVec3dCenter
...
fun World.noCollision(pos: BlockPos) = this.checkNoEntityCollision(AxisAlignedBB(pos), Wrapper.player)