...
inline fun World.notBlockExpandY(entityPlayer: EntityPlayer, blockType: Block, expandY: Int): Boolean {
    return getBlockState(BlockPos(entityPlayer).add(0, expandY, 0)).block != blockType
}

inline fun World.notBlock(entityPlayer: EntityPlayer, blockType: Block): Boolean {
    return getBlockState(BlockPos(entityPlayer)).block != blockType
}
