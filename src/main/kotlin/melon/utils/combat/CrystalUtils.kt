...
import dev.zenhao.melon.module.modules.crystal.CrystalHelper.setAndAdd
...
object CrystalUtils {
    ...
    fun SafeClientEvent.canPlaceCrystal(pos: BlockPos): Boolean {
        ...
        for (target in ArrayList(IModule.mc.world.loadedEntityList)) {
    ...
    fun getCrystalPlacingBB(pos: BlockPos): AxisAlignedBB {
        return getCrystalPlacingBB(pos.getX(), pos.getY(), pos.getZ())
    }
    ...
    fun getCrystalBB(pos: BlockPos): AxisAlignedBB {
        return getCrystalBB(pos.getX(), pos.getY(), pos.getZ())
    }
    ...
    fun crystalPlaceBoxIntersectsCrystalBox(placePos: BlockPos, crystalX: Double, crystalY: Double, crystalZ: Double): Boolean {
        return (crystalY.fastFloor() - placePos.getY()).withIn(0, 2)
                && (crystalX.fastFloor() - placePos.getY()).withIn(-1, 1)
                && (crystalZ.fastFloor() - placePos.getY()).withIn(-1, 1)
    }
    ...
    fun crystalIntersects(crystal1: BlockPos, crystal2: BlockPos): Boolean {
        return crystalIntersects(crystal1.getX(), crystal1.getY(), crystal1.getZ(), crystal2.getX(), crystal2.getY(), crystal2.getZ())
    }

    fun crystalIntersects(crystal1: BlockPos, crystal2: Vec3d): Boolean {
        return crystalIntersects(crystal1.getX(), crystal1.getY(), crystal1.getZ(), crystal2.x, crystal2.y, crystal2.z)
    }

    fun crystalIntersects(crystal1: Vec3d, crystal2: BlockPos): Boolean {
        return crystalIntersects(crystal2.getX(), crystal2.getY(), crystal2.getZ(), crystal1.x, crystal1.y, crystal1.z)
    }
    ...
    fun crystalIntersects(crystal1: EntityEnderCrystal, crystal2: BlockPos): Boolean {
        return crystalIntersects(crystal2.getX(), crystal2.getY(), crystal2.getZ(), crystal1.posX, crystal1.posY, crystal1.posZ)
    }
