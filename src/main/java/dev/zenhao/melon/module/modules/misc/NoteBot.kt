...
import dev.zenhao.melon.gui.window.WindowChooser
...
class NoteBot : Module() {
    ...
    private fun tunePre(event: PlayerMotionEvent) {
        currentPos = null
    ...
    private fun noteBotPre(event: PlayerMotionEvent) {
        posList.clear()
        if (registers == null) {
            return
        }
    ...
    inner class SongChooser : GuiScreen() {
        ...
        override fun drawScreen(mouseX: Int, mouseY: Int, partialTicks: Float) {
            val point = SettingPanelUtils.calculateMouseLocation()
        ...
        override fun keyTyped(typedChar: Char, keyCode: Int) {
            window.keyPressed(typedChar, keyCode)
