...
import dev.zenhao.melon.command.commands.CreditsCommand;
import dev.zenhao.melon.command.commands.FriendCommand;
import dev.zenhao.melon.command.commands.HelpCommand;
import dev.zenhao.melon.command.commands.comm.BindCommand;
import dev.zenhao.melon.command.commands.comm.CommandsCommand;
import dev.zenhao.melon.command.commands.comm.PrefixCommand;
import dev.zenhao.melon.command.commands.gui.FixGuiCommand;
import dev.zenhao.melon.command.commands.mc.*;
import dev.zenhao.melon.command.commands.module.*;
...
public class CommandManager {
    ...
    public CommandManager() {
        ...
        Melon.logger.info("Commands initialised");
    }
