...
public class Notification {
    ...
    public void draw(double getY, double lastY) {
        ...
        MelonTessellator.drawRect(x1, y1, x2, y2, reAlpha(color, 0.85f));
        MelonTessellator.drawRect(x1, y2 - 1, x1 + Math.min((x2 - x1) * (System.currentTimeMillis() - timerUtils.getTime()) / stayTime, x2 - x1), y2, reAlpha(-1, 0.85f));
    ...
    public boolean isFinished() {
        return timerUtils.passed(stayTime) && posY == lastY;
    }
