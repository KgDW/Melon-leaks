package dev.zenhao.melon.gui.alt;

import com.mojang.realmsclient.gui.ChatFormatting;
import dev.zenhao.melon.gui.alt.utils.*;
...
import dev.zenhao.melon.gui.window.EmptyWindowNoDrag;
import dev.zenhao.melon.gui.window.components.ButtonAlt;
...
public final class GuiAlt extends GuiScreen {
    ...
    protected void keyTyped(char character, int key) {
        ...
        window.keyPressed(character, key);
    }
