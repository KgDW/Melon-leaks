...
public class ColorPicker extends SettingButton<Color> {
    ...
    public void render(int mouseX, int mouseY, float partialTicks) {
        ...
        //RenderUtils.drawCircle(this.x + this.width - this.headerHeight + 3, this.y + this.headerHeight / 2D, (this.headerHeight - 4) / 2D, this.getColor());
        RenderUtils.drawRect(this.x + this.width - this.headerHeight, this.y + (this.headerHeight - (this.headerHeight - 2)), this.headerHeight - 4, this.headerHeight - 4, this.getColor());
        if (this.extend) {
            if (Mouse.isButtonDown(0) && this.isPointInColor(this.colorPanelX, this.colorPanelY, this.radius, mouseX, mouseY)) {
                this.selectedX = mouseX - this.colorPanelX;
                this.selectedY = mouseY - this.colorPanelY;
            } else if (Mouse.isButtonDown(0) && this.isHovered(this.x + this.width / 16 * 7 + 5, this.y + 2, this.width / 6, this.height - 4, mouseX, mouseY)) {
            ...
            if (this.getValue().getValue().getRGB() != this.getColor().getRGB()) {
